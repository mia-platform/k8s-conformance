...
```shell
curl -fsSL https://github.com/mia-platform/vab/releases/download/v0.11.0/vab-linux-amd64 > /tmp/vab
...
```shell
curl -fsSL https://raw.githubusercontent.com/mia-platform/distribution/v1.31.0/examples/base/config.yaml > config.yaml
```
